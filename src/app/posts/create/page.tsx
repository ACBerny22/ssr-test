                        ...
                        >
                            <div>
                                ...
                                <input
                                    ...
                                    name="title"
                                    id="username"
                                    className=" border  text-sm lg:text-lg rounded-lg font-light focus:ring-primary-600 
                                    focus:border-primary-600 block w-full p-2.5 bg-gray-700 border-gray-600
                                     placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                                    placeholder="Sassy title..."
                                    required
                                />
                            </div>
                            <div>
                                ...
                                <textarea
                                    ...
                                    className=" border font-light text-sm lg:text-lg rounded-lg focus:ring-primary-600
                                     focus:border-primary-600 block w-full p-2.5 bg-gray-700 border-gray-600
                                     placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                                    required
                                />
                            ...
                            <div className="flex justify-end gap-5">
                                <button
                                    type="submit"
                                    className="  font-bold rounded-lg text-lg p-3"
                                >
                                    Cancel
                                </button>
                                <button
                                    type="submit"
                                    className=" text-gray-800 font-bold rounded-lg text-lg bg-white p-3"
                                >
                                    Publish
                                </button>
                            </div>
