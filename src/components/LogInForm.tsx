                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        ...
                                        name="username"
                                        id="username"
                                        className="border sm:text-sm rounded-lg text-white
                                ...
                                <button
                                    type="submit"
                                    className="w-full text-white  focus:ring-4 focus:outline-none focus:ring-primary-300
                                    font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-gradient-to-r from-teal-400 to-violet-500 hover:opacity-80"
                                >
                                    Sign in
                                </button>
